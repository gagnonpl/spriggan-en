...
- QoL features
  - Auto-save game progress and options settings
...
<table align="center">
  <tr>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/title-screen.png">
        <img src="screenshots/title-screen.png" width="320" alt="Title screen">
      </a>
    </td>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/cutscene-1.png">
        <img src="screenshots/cutscene-1.png" width="320" alt="cutscene-1">
      </a>
    </td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/story-cutscene.png">
        <img src="screenshots/story-cutscene.png" width="320" alt="story-cutscene">
      </a>
    </td>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/weapons-demo.png">
        <img src="screenshots/weapons-demo.png" width="320" alt="weapons-demo">
      </a>
    </td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/cutscene-2.png">
        <img src="screenshots/cutscene-2.png" width="320" alt="cutscene-2">
      </a>
    </td>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/act-title.png">
        <img src="screenshots/act-title.png" width="320" alt="act-title">
      </a>
    </td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/in-level-speech.png">
        <img src="screenshots/in-level-speech.png" width="320" alt="in-level-speech">
      </a>
    </td>
    <td>
      <a href="https://github.com/gagnonpl/spriggan-en/raw/master/screenshots/credits.png">
...
| File | Description |
| --- | --- |
| [`spriggan-english-track02-v1.0.xdelta`](https://github.com/gagnonpl/spriggan-en/releases/download/v1.0/spriggan-english-track02-v1.0.xdelta) | xdelta patch for track 02 |
| [`spriggan-english-track27-v1.0.xdelta`](https://github.com/gagnonpl/spriggan-en/releases/download/v1.0/spriggan-english-track27-v1.0.xdelta) | xdelta patch for track 27 |
| [`README.txt`](https://raw.githubusercontent.com/gagnonpl/spriggan-en/v1.0/README.txt) | Instructions and hashes |
...
```sh
xdelta3 -f -d \
  -s "Seirei Senshi Spriggan (Japan) (Track 02).bin" \
  spriggan-english-track02-v1.0.xdelta \
  "Seirei Senshi Spriggan (Japan) (Track 02)-patched.bin"

xdelta3 -f -d \
  -s "Seirei Senshi Spriggan (Japan) (Track 27).bin" \
  spriggan-english-track27-v1.0.xdelta \
  "Seirei Senshi Spriggan (Japan) (Track 27)-patched.bin"
```
